...
| Flush Buffer      | FLUSH_BUFFER          | string | Make producer flushed blocking it until previous messaged have been delivered effectively (flush the queue after every message), to make it synchronous.                                                    |
